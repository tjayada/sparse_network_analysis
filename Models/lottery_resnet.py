...
class ResNet(nn.Module):
    ...
    def __init__(self, plan, num_classes, dense_classifier):
        ...
        # print(synflow_parser_args.dataset)
        # print(gem_miner_parser_args.dataset)
        # if tt == "MNIST" or tt == "mnist": ? 
        if synflow_parser_args.dataset == "MNIST" or synflow_parser_args.dataset == "mnist":
            self.conv = layers.Conv2d(1, current_filters, kernel_size=3, stride=1, padding=1, bias=False)
        else: 
