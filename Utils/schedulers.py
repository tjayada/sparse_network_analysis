...
def get_scheduler(optimizer, policy='multistep_lr', milestones=[80, 120], gamma=0.1, max_epochs=150):
    ...
    if gem_miner_parser_args.epochs in [6]:
        milestones = [3,]
        gamma = gem_miner_parser_args.lr_gamma
    elif gem_miner_parser_args.epochs == 100:
        milestones = [50, 80]
        max_epochs = 100
    elif gem_miner_parser_args.epochs in [150, 160]:
        milestones = [80, 120]
